...
@implementation VisualizationEngine
...
-(void) updateBackground:(VideoFrame) frame
{
    ...
    glBindTexture(GL_TEXTURE_2D, m_backgroundTextureId);
    glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, frame.width, frame.height, 0, GL_BGRA, GL_UNSIGNED_BYTE, frame.baseAddress);
